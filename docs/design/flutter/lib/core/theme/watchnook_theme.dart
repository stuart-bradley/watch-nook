...
/// (Or bundle the two families and swap the GoogleFonts calls for
/// TextStyle(fontFamily: ...).)
///
/// Minimum Flutter 3.22 (uses ColorScheme surfaceContainer roles and
...
class WatchnookTheme {
  ...
  static TextTheme _textTheme(ColorScheme cs) {
    ...
    return sans
        .copyWith(
          displayLarge: serif.displayLarge?.copyWith(fontWeight: FontWeight.w500),
          displayMedium: serif.displayMedium?.copyWith(fontWeight: FontWeight.w500),
          displaySmall: serif.displaySmall?.copyWith(fontWeight: FontWeight.w500),
          headlineLarge: serif.headlineLarge?.copyWith(fontWeight: FontWeight.w600),
          headlineMedium: serif.headlineMedium?.copyWith(fontWeight: FontWeight.w600),
          headlineSmall: serif.headlineSmall?.copyWith(fontWeight: FontWeight.w600),
